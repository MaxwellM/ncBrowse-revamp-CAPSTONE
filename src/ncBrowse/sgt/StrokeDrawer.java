...
public interface StrokeDrawer {
    ...
    void drawHeavy(Graphics g, int[] xout, int[] yout, int size,
                   LineAttribute attr);

    void drawDashed(Graphics g, int[] xout, int[] yout, int size,
                    LineAttribute attr);

    void drawStroke(Graphics g, int[] xout, int[] yout, int size,
                    LineAttribute attr);

    void drawHighlight(Graphics g, int[] xout, int[] yout, int size,
                       LineAttribute attr);
}
