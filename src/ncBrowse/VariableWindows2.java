...
public class VariableWindows2 extends JFrame {
  private static BorderLayout borderLayout3 = new BorderLayout(0, 0);
  ...
  public static int locWin1X;
  public static int locWin1Y;
  public static int locWin2X;
  public static int locWin2Y;
  public static int locWin3X;
  public static int locWin3Y;
  public static int locWin4X;
  public static int locWin4Y;
  public static int locWin5X;
  public static int locWin5Y;
  public static int locWin6X;
  public static int locWin6Y;
  public static int locWin7X;
  public static int locWin7Y;
  public static int locWin8X;
  public static int locWin8Y;
  public int locXMid;
  public int locYMid;

  public static int whatframe;

  public VariableWindows2(){
  ...
  public static void openVariableWindows(){
    prepareWin1GUI();
    prepareWin2GUI();
    prepareWin3GUI();
    prepareWin4GUI();
  ...
  public int getWinSizeWidth(){
    return winSizeWidth;
  }
  public int getWinSizeHeight(){
    return winSizeHeight;
  }
  public int getLocXMid(){
    return locXMid;
  }
  public int getLocYMid(){
    return locYMid;
  }

  public static void prepareWin1GUI(){
  ...
  public static void prepareWin2GUI(){
  ...
  public static void prepareWin3GUI(){
  ...
  public static void prepareWin4GUI(){
  ...
  public static void prepareWin5GUI(){
  ...
  public static void prepareWin6GUI(){
  ...
  public static void prepareWin7GUI(){
  ...
  public static void prepareWin8GUI(){
