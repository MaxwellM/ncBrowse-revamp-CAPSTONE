...
public abstract class SoTRange implements java.io.Serializable, Cloneable {
     ...
     * <code>GeoDate</code>.
     * @since sgt 2.0
     * @deprecated As of sgt 3.0, replaced by {@link ncBrowse.sgt.geom.SoTRange.Time SoTRange.Time}
     */
    public static class GeoDate extends SoTRange {
        /** The range's first time  */
        public ncBrowse.sgt.geom.GeoDate start = null;
        /** The range's last time  */
        public ncBrowse.sgt.geom.GeoDate end = null;
        /** The range's time increment  */
        public ncBrowse.sgt.geom.GeoDate delta = null;
        /**
        ...
        public GeoDate(ncBrowse.sgt.geom.GeoDate tstart,
                       ncBrowse.sgt.geom.GeoDate tend,
                       ncBrowse.sgt.geom.GeoDate tdelta) {
            this.start = tstart;
            this.end = tend;
            this.delta = tdelta;
        }
        ...
        public GeoDate(TimeRange trange) {
            start = new ncBrowse.sgt.geom.GeoDate(trange.start.getTime());
            end = new ncBrowse.sgt.geom.GeoDate(trange.end.getTime());
            if(trange.delta != null) {
                delta = new ncBrowse.sgt.geom.GeoDate(trange.delta.getTime());
            } else {
                delta = null;
            }
        }
        ...
        public void flipStartAndEnd() {
            ncBrowse.sgt.geom.GeoDate save = end;
            end = start;
            start = save;
        }
        ...
        public SoTRange copy() {
            ncBrowse.sgt.geom.GeoDate cStart = null;
            ncBrowse.sgt.geom.GeoDate cEnd = null;
            ncBrowse.sgt.geom.GeoDate cDelta = null;
            if(start != null)
                cStart = new ncBrowse.sgt.geom.GeoDate(start.getTime());
            if(end != null)
                cEnd = new ncBrowse.sgt.geom.GeoDate(end.getTime());
            if(delta != null)
                cDelta = new ncBrowse.sgt.geom.GeoDate(delta.getTime());
    ...
    public static class Time extends SoTRange {
        ...
        public Time(ncBrowse.sgt.geom.GeoDate ustart,
                    ncBrowse.sgt.geom.GeoDate uend) {
        ...
        public Time(ncBrowse.sgt.geom.GeoDate ustart,
                    ncBrowse.sgt.geom.GeoDate uend,
                    ncBrowse.sgt.geom.GeoDate udel) {
