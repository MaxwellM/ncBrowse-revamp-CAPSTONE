...
import ncBrowse.sgt.dm.SimpleLine;
import ncBrowse.sgt.dm.SimpleGrid;
...
class Temperature implements java.io.Serializable {
    ...
    //
    private static final String timeArrayName = "[Lsgt.geom.GeoDate";
    ...
    static SGTData convertToBaseUnit(SGTData grid, int comp) {
        ...
        default:
        case Units.X_AXIS:
            meta = grid.getXMetaData();
            break;
        case Units.Y_AXIS:
            meta = grid.getYMetaData();
            break;
        case Units.Z_AXIS:
        ...
        if(grid instanceof SGTLine) {
            ...
            case Units.X_AXIS:
                if(simpleLine) {
                    ...
                    ((SimpleLine)new_grid).setYMetaData(grid.getYMetaData());
                }
            ...
            case Units.Y_AXIS:
                if(simpleLine) {
                    ...
                    ((SimpleLine)new_grid).setXMetaData(grid.getXMetaData());
                }
            ...
            case Units.X_AXIS:
                if(simpleGrid) {
                    ...
                    ((SimpleGrid)new_grid).setYMetaData(grid.getYMetaData());
            ...
            case Units.Y_AXIS:
                if(simpleGrid) {
                    ...
                    ((SimpleGrid)new_grid).setXMetaData(grid.getXMetaData());
                    ((SimpleGrid)new_grid).setZMetaData(((SGTGrid)grid).getZMetaData());
                }
