 ...
 */
package ncBrowse.sgt.swing.prop;
...
import ncBrowse.sgt.IndexedColor;
import ncBrowse.sgt.swing.ColorSwatchIcon;
import ncBrowse.sgt.IndexedColorMap;
...
public class GridAttributeDialog extends JDialog {
     ...
     * {@link ncBrowse.sgt.JPane#setBatch(boolean) batching} so
